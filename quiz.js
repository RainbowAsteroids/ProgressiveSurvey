...
function init(data) {
    ...
    document.title = "Quiz "+quizData.title+" by: "+quizData.author;
...
function results(data) {
    for (var element of mainElement.getElementsByClassName("error")) {
    ...
    data.questions.forEach(function(question) {
        let answered = false;
        for (var input of document.getElementsByName(question.title)) {
